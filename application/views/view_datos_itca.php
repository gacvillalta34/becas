			...
			<div class="row">
					<div class="col-md-6">
						<?php
								...
								$result7 = @mysql_query("SELECT COUNT(*) AS total7 FROM estudiantes WHERE institucion_ingreso = 'ITCA'");
								$data7 =@mysql_fetch_assoc($result7);
							?>
							<div class="panel-content">
							<div id="demo-pie-chart8" class="ct-chart">CANTIDAD DE BECADOS ITCA: <?php echo $data7['total7'] ?></div>
						</div>
					 </div>
					</div>
					</div>
				<form action="crud" method="post">
					...
					<div class="profile-section">
							<h2 class="profile-heading"><div align="center">ITCA</h2></div>
							<div class="clearfix">
							<!-- LEFT SECTION -->
									<div class="left">
									<div class="form-group">
											...
											<select class="form-control" name="estudian">
												...
												$itca = "ITCA";
												$query1 = "SELECT * FROM estudiantes WHERE institucion_ingreso = '$itca' LIMIT 0, 100";
										...
										<div class="form-group">
											...
											<select class="form-control" name="estudian2">
												...
												mysql_query ("SET NAMES 'utf8'");
												$itca = "ITCA";
												$query1 = "SELECT * FROM estudiantes WHERE institucion_ingreso = '$itca' LIMIT 200, 300";
												$resultado1 = mysql_query($query1);
												while($fila1 = mysql_fetch_array($resultado1))
												{
												?>
										...
										<div class="form-group">
											...
											<select class="form-control" name="estudian3">
												...
												mysql_query ("SET NAMES 'utf8'");
												$itca = "ITCA";
												$query1 = "SELECT * FROM estudiantes WHERE institucion_ingreso = '$itca' LIMIT 100, 200";
												$resultado1 = mysql_query($query1);
												while($fila1 = mysql_fetch_array($resultado1))
												{
												?>
										...
										<div class="form-group">
											...
											<select class="form-control" name="estudian4">
												...
												mysql_query ("SET NAMES 'utf8'");
												$itca = "ITCA";
												$query1 = "SELECT * FROM estudiantes WHERE institucion_ingreso = '$itca' LIMIT 300, 400";
												$resultado1 = mysql_query($query1);
												while($fila1 = mysql_fetch_array($resultado1))
												{
												?>
